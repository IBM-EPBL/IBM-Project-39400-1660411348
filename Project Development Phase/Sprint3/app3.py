...
app.config['hostname'] = 'ba99a9e6-d59e-4883-8fc0-d6apip8c9f7a08f.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud'
'SSLServerCertificate=DigiCertGlobalRootCA.crt;'
app.config['port'] = '31321'
app.config['protocol'] = 'tcpip'
app.config['uid'] = 'bcq60318'
app.config['pwd'] = 'vMtaX6co5RqeRC41'
...
try:
    ...
    conn_str='database=bludb;hostname=ba99a9e6-d59e-4883-8fc0-d6a8c9f7a08f.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;port=31321;protocol=tcpip;\
            uid=bcq60318;pwd=vMtaX6co5RqeRC41;security=SSL'
